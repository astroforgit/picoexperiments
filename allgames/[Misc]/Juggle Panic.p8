...
--[[
hello! in order to pack this
cart full of fun lil' modes
while still getting it in
under compressed size
limitations, i've stripped this
cart of all its tabs and
comments. if you'd like to hack
on this cart, i'd recommend
checking out the code here:
https://github.com/bridgs/juggle-panic/blob/master/cart.p8
...
sfx(ternary(ball_speed_rating>25,11,10),2)
self.anim_frames=20
self.anim="catch"
self.wiggle_frames=0
if mode!="leapfrog mode" then
...
draw_sprite(88,91,9,10,14-n,48)
draw_sprite(99,91,9,10,25-n,48)
draw_sprite(91,118,9,10,93+n,48,true)
draw_sprite(91,118,9,10,104+n,48)
if mode!="pong mode" then
draw_sprite(64,118,27,10,11-n,68)
draw_sprite(88,101,9,10,99+n,68)
end
pal()
