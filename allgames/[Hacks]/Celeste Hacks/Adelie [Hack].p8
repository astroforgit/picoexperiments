...
message={
  ...
  last=0,
  draw=function(this)
    this.text=" -- adelie mountain -- # 1.5 million penguins  #found on danger islands"
    if this.check(player,4,0) then
      ...
      this.off={x=camx+8,y=camy+96}
      for i=1,this.index do
        if sub(this.text,i,i)~="#" then
          rectfill(this.off.x-2,this.off.y-2,this.off.x+4,this.off.y+6,7)
...

