...
if corrupt then
  ...
  for y=y1,y2 do
	...
	if is_title() then
 	...
 	if btnp(0,1) then speed -= 5
 	elseif btnp(1,1) then speed += 5 end
		if btnp(4,1) then
			if interlace then
				interlace = false
			elseif not interlace then
				interlace = true
			end
		end
		if btnp(5,1) then
...
function _draw()
	...
	sine_xshift(time()-launch,amp,length,speed,0,127,interlace)	
	-- particles
	...
	if is_title() then
		print("a/q",80,10,5)
		print("audiocorr:",15,10,5)
		print(corrupt,58,10,5)
		print("shift",80,20,5)
		print("interlace:",15,20,5)
		print(interlace,58,20,5)
		print( amp, 58,108,5)
		print( length, 58,114,5)
		print( speed,58,120,5)
		print( "‹‘", 70,108,5)
		print( "ƒ”", 70,114,5)
		print( "s+f",70,120,5)
		print( "amp", 30,108,5)
		print( "length", 30,114,5)
		print( "speed",30,120,5)
		print("x+c",58,80,5)
