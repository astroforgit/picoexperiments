   ...
   init_object(smoke,this.x,this.y)
  	...
  	if abs(this.spd.y) <= 0.15 then
   	gravity*=0.5
		...
		-- next level
		if this.y>128 and level_index()>0 then next_room() end
...
flower={
	...
	last=0,
	draw=function(this)
		this.text="congrats madeline!#you made it up and#down the mountain."
		if room.x == 0 and room.y == 0 and this.check(player,4,0) then
			if this.index<#this.text then
			 this.index+=.5
				if this.index>=this.last+1 then
				 this.last+=1
...
function _draw()
	...
	if is_title() then
		print("x+c",58,80,5)
		print("revolutionizethegame",24,16,5)
		print("presents:",48,24,5)
		print("original game by",33,90,5)
...
__gff__

...
__sfx__
000200001337013470133701d4702a37017470273701347023370114701e3700e4701a3600c46016350084401233005420196001960019600196003f6003f6003f6003f6003f6003f6003f6003f6003f6003f600
