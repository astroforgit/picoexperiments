...
waterfall={
		init=function(this)
				this.t=0
				while (not this.is_solid(0,8) and this.hitbox.h<128)	this.hitbox.h+=8
		end,
		update=function(this)
				local hit=this.check(player,0,0)
				while (not this.is_solid(0,1) and this.hitbox.h<128)	this.hitbox.h+=1
		  ...
		  if (hit and maybe()) hit.spd.y+=0.2
		end,
		draw=function(this)
				this.t=(this.t+1)%8
