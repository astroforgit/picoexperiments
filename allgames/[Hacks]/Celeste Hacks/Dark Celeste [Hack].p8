...
set_hair_color=function(djump)
	pal(8,(djump==1 and 7 or djump==2 and (flr((frames/3)%2)*7) or 0))
end
...
lifeup = {
	...
	draw=function(this)
		...
		print("1000",this.x-2,this.y,this.flash%2==0 and 0 or 7)
	end
}
...
room_title = {
	...
	draw=function(this)
		...
		elseif this.delay<0 then
			...
			rect(26,58,104,70,7)
			--print("---",31,64-2,7)
			if room.x==5 and room.y==0 then
				print("",48,62,7)
			elseif level_index()==30 then
				print("surface",52,62,7)
			else
				local level=(-6+(1+level_index()))*100
				print(level.." m",50+(level>-1000 and 2 or 0),62,7)
			end
			--print("---",86,64-2,7)
...
function _update()
	...
	frames=((frames+1)%30)
	if frames==0 and level_index()<5 then
...
function _draw()
	...
	--tixy (see tab 1)
	if (not is_title()) tdraw()

	-- clouds
	if false and not is_title() then
	...
	foreach(dead_particles, function(p)
		...
		rectfill(p.x-p.t/5,p.y-p.t/5,p.x+p.t/5,p.y+p.t/5,7)
	end)
	...
	if is_title() then
		print("x+c",58,80,7)
		print("matt thorson",42,96,7)
		print("noel berry",46,102,7)
		print("mod: kikoodx",42,114,7)
	end
...
local scale = 4
local thold = 0.11
local dcnt = width * width

function tupdate()
	t += 1
end

function noice(t,i,x,y)
	return i/dcnt*((t/256)%1)
end

function ripeyes(t,i,x,y)
	return sin(x+y*i*(t%16)/128)
end

function tdraw()
	if (tdisabled) return nil
	local tixy = noice
	local ox, oy = 0, 0
	local i = 0
	for y=0, width, 1 do
		for x=0, width, 1 do
			local val = tixy(t,i,x,y)
			val = val > thold and 7 or
				val < -thold and 0 or 0
			local px = (x+ox) * scale
			local py = (y+oy) * scale
			rectfill(px, py, px+scale-1, py+scale-1, val)
			i += 1
		end
	end
end
__gfx__

...
__gff__

__map__

