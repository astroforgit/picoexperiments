...
player = 
{
	init=function(this) 
		...
		this.dash_jump_effect=0
		this.wall_dash=false
		this.wall_dash_effect=0
		this.wall_dash_possible=false
		create_hair(this)
	end,
	update=function(this)
		...
		if on_ground then
			if not this.wall_dash_possible then
				this.grace=6
			end
  ...
  if this.dash_time > 0 then
   init_object(smoke,this.x,this.y)
  	...
  	if this.jbuffer > 0 then
  		...
  		if (wall_dir!=0 and this.wall_dash_possible) or (not this.wall_dash_possible) then
  			this.dash_time = 0
  		end
  	end
  else
			...
			if on_ground or abs(this.spd.x)<0.5 or sign(input)!=sign(this.spd.x) then
				this.dash_jump = false
			end
			
			if on_ground or abs(this.spd.y)<0.5 then
				this.wall_dash_possible = false
			end
			...
			if this.dash_jump then
				maxrun=3
				accel=10
				this.dash_jump_effect+=1
				if this.dash_jump_effect>5 then
					init_object(dashring, this.x-sign(this.spd.x)*2, this.y)
					this.dash_jump_effect=0
				end
			end
			...
			if this.wall_dash then
				...
				this.wall_dash_effect+=1
				if this.wall_dash_effect>5 then
					init_object(walldashring, this.x, this.y)
					this.wall_dash_effect=0
				end
			end
  	...
  	if abs(this.spd.y) <= 0.15 then
   	gravity*=0.5
		 	...
		 	if this.grace>0 then
		 		if this.dash_effect_time>0 then
		  		...
		  		this.grace=0
					...
					if this.dash_effect_time>0 and this.wall_dash_possible then
						--wall dash
 					local wall_dir=(this.is_solid(-3,0) and -1 or this.is_solid(3,0) and 1 or 0)
 					if wall_dir!=0 then
 						this.wall_dash_possible=false
 			 		...
 			 		this.dash_jump=false
 			 		this.wall_dash=true
 			 		this.wall_dash_effect=3
 			 		this.jbuffer=0
 			 		this.spd.y=-3
 			 		this.spd.x=-wall_dir*(maxrun+0.5)
		...
		-- next level
		if this.y<-4 and level_index()<6 then next_room() end
...
dashring={
	...
	draw=function(this)
		rect(this.x-2, this.y-3*this.spr, this.x+2, this.y+3*this.spr, 6)
	end
}
...
walldashring={
	...
	draw=function(this)
		rect(this.x-3*this.spr, this.y-2, this.x+3*this.spr, this.y+2, 6)
	end
}
...
function _update()
	frames=((frames+1)%30)
	if frames==0 and level_index()<6 then
...
function _draw()
	...
	if is_title() then
		print("—+Ž",56,80,5)
		print("matt thorson",42,90,5)
		print("noel berry",46,96,5)
		print("mod by rubyred",38,102,5)
  print("levels by sheebeehs",28,108,5)
	end
...

...
000000000000110176851100b1b3026184621111111100000061000000b3135200000000828382000082768200000000000000000096a6b6c6d6e6f600000000
...
0000000000b30282828372b26100b100525232122232b200000000000000b14200000000a28282000082839200000000000000000097a7b7c7d7e7f700000000
...
001100000000b1a2828273b200000000232333132333b200001111000000b342000000868382000000008293a300000000000000000000000000000000000000
...
b302b211000000110092b100000000a3b1b1b1b1b1b10011111232110000b342000000a282000000000000828386000000000000000000000000000000000000
...
00b1b302b200b372b200000000000082b21000000000b31222522363b200b3138585868292000000000000018282860000000000000000000000000000000000
...
100000b10000b303b200000000858682b27100000000b3425233b1b1000000b182018283000000000000009200a2820000000000000000000000000000000000
...
329300000000b373b200000000a20182111111110000b31333b100a30061000000a2829300000000000000000000820000000000000000000000000000000000
...
62820000000000b100000093a382838222222232b20000b1b1000083000000860000000000000000000000008293827600000000000000000000000000000000
...
62839321000000000000a3828282820152845262b261000093000082a300a3821000000000000000000000000001838200000000000000000000000000000000
...
628201729300000000a282828382828252528462b20000a38300a382018283821222322222222222222222222222223200000000000000000000000000000000
__gff__

__map__

...
010200000132604326073262c036210462e0363603623026240162c02631026390463a03630026230162c0002c626246161851518515185001850000000000000000000000000000000000000000000000000000
__music__
01 15 0a 43 44
00 0a 16 0c 44
00 0a 16 0c 44
