...
function title()
 ...
 nice_print("‹ ride on line no."..seed.." ‘",17,100,7,15)
 nice_print("— to depart, Ž to view",17,110,7,15)
 nice_print("” "..c_msg.." ƒ credits",2,120,7,15)
end
...
function update_controls()
 if show_title then
  ...
  show_credits=false
  if(btn(ƒ))show_credits=true

  if(btnp(”))only_slightly_chill=not only_slightly_chill
  
  show_route=false
  if(btn(Ž))show_route=true
  return
 end
