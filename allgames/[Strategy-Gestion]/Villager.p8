...
function draw_ui()
	...
	printol("Ž"..olbl,cx+3,cy+lbl_off+105,15,4)
...
function draw_menu()
	...
	for i=1,9 do
		...
		if (menu_start>1) print("”",x+w-1,y,4)
		if (menu_start<#menu-8) print("ƒ",x+w-1,y+h-8,4)
...
function init_buildings()
	...
	menu=
		{ "general"
		, m(blds.house,place_house,40,20,"” happiness,peeple\n’ road,workshop,crops")
		, m(blds.road,place_road,3,0,"places dirt road\n’ bridge,well")
		, m(blds.bridge,place_bridge,10,10,"to cross rivers\nmust be on hor/ver\nwater")

		, "resources"
		, m(blds.workshop,place_workshop,50,50,"” wood & stone\n’ forester,quarry\n   fisher")
		, m(blds.lodge,place_lodge,70,50,"”” wood\n’ woodpile,plants")
		, m(blds.quarry,place_quarry,50,70,"”” stone\n’ stonepile")
		
		, "food"
		, m(blds.crops,place_crops,30,0,"grows farmable food\n’ windmill")
		, m(blds.windmill,place_windmill,150,200,"farms surr. crops\n” food storage\n’ tavern")
		, m(blds.fisher,place_fisher,50,30,"” food\nmust be near water")
		, m(blds.mushroom,plant_mushroom,3,0,"plants a mushroom")
	
		, "happiness"
		, m(blds.well,place_well,30,60,"” happiness")
		, m(blds.tavern,place_tavern,200,250,"”” happiness")
		, m(blds.chapel,place_chapel,250,400,"””” happiness")		
		...
		, m(blds.stonepile,place_stonepile,0,50,
					"” stone storage (+25)")
		, m(blds.storage,place_storage,100,100,"” wood & stone\n   storage (+50)")
