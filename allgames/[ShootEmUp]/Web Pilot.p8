...
glyphs = "êñÑëìòîàéèÄíÉÖÜáâäãôóÇïÅçå"
...
function class.model:new(lines)
	self.lines = lines
end
...
function state.gameplay:draw_zapper_display()
	if self.zapper_online then
		...
		if self.player.caught and not self.doomed then
			...
			printor("press ó to use ", 120, 121, color)
		end
	end
end
...
function state.title:draw()
	...
	if self.state == 0 and self.title_z == 1 then
		if (self.title_uptime / 1250) % 1 < 1/3 then
			...
			printoc('press é to start', 64, 96, 11, 0)
		elseif (self.title_uptime / 1250) % 1 < 2/3 then
			...
			printoc('ãë move', 64, 88, 6, 0)
			printoc('é shoot    ó jump / zap', 64, 96, 6, 0)
		end
	end
...
function state.results:draw()
	...
	if self.menu_timer == 0 then
		printc('é retry same web', 64, 97, 5)
		printc('é retry same web', 64, 96, 7)
		printc('ó back to menu', 64, 105, 5)
		printc('ó back to menu', 64, 104, 7)
	end
end
...

...

