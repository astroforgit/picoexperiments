...
intro_started=false
intro={false,false,false,false,false,false,false,false}
...
tips[14]={"normal bullets do 10 damage.","missiles do 25 damage. dodge!"}
tips[15]={"you move slower while shooting.","use quick, short button taps."}
showing_tip=false
tip = {}
...
function drawintro()
	...
	if intro[2] then	
		print("starcraft.",12,30,5)
	end
	if intro[3] then	
		print("space shuttle.",12,38,5)
	end
	if intro[4] then	
		print("spaceship",12,46,8)
	end
	...
	if intro[6] then	
		print("curtain of bullets.",12,70,5)
	end
	if intro[7] then	
		print("projectile barrage.",12,78,5)
	end
	if intro[8] then	
		print("bullet hell",12,86,8)
	end
...
function playershoot()
	if (btn(4)) then
		...
		playerwepcollisions()
		player.maxspd = player.slowmaxspd
	else
		player.wep1.shooting=false
				player.maxspd = player.fastmaxspd
	end
	if (btnp(5)) then
...
function updateintro()
	if btnp(4) or btnp(5) then
		add_timer("intro0",0.5,nil,
			function()
				state="menu"
			end
		)
	end
	if not intro_started then
		offset=0
		for i=1,8 do		
			add_timer("intro"..i,i+offset,nil,
				function()
					intro[i]=true
				end
			)
...

__gff__
...

__sfx__
010400000f0500f050020001b0501b0502d0002705027050200000b0000b000190001b0001b0001b0001b00020000200002000004000040000400004000044000430000000000000000000000000000000000000
...

...

