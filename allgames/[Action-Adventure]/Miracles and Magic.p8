...
function update_game()
    ...
    if #dtb_queu == 0 then
        ...
        if player.hp <= 0 then
            if current_boss.id == christopher then
                remove_sight()
            end
            game_over()
        end
...
function control_player(pl)
    ...
    left_press = button_press(‹)
    right_press = button_press(‘)
    up_press = button_press(”)
    down_press = button_press(ƒ)
...
function read_sign(room_id)
    ...
    elseif room_id == 18 then
        ...
        txt_wr("\"press Ž to map your surroundings with magic\"!", 0, 51)
        txt_wr("...heh.", 0, 48)
...
function get_boss_bullets(boss, phase, bullet_pointer)
    if boss.id == skelly then
        ...
        elseif phase == 2 then
            if bullet_pointer < 91 then
                if bullet_pointer % 30 == 1 or bullet_pointer % 30 == 3 then
                ...
                elseif bullet_pointer % 30 == 0 then
    ...
    elseif boss.id == mutant then
        ...
        elseif phase == 2 then
            if bullet_pointer % 4 == 0 then
                local offset = (bullet_pointer % 180)/180
                if bullet_pointer < 100 then
                    return get_circle_pattern(0 + offset, 1 + offset, 4, 0.1)
                elseif bullet_pointer > 240 then
                    return {reset_bullet}
                end
            end
        elseif phase == 3 then
            if bullet_pointer == 60 then
                local offset = rnd()
                return get_circle_pattern(offset, min(1 + offset, 1 + rnd()), 30, 0.1)
            elseif bullet_pointer % 15 == 0 and bullet_pointer < 110 then
                return get_aim_pattern(boss, 0.1)
            elseif bullet_pointer > 160 then
                return {reset_bullet}
            end
        elseif phase == 4 then
...

