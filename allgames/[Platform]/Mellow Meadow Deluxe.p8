...
--other
 ...
 --toggle jump btn in pause menu
  menuitem(1,"swap ó/é",function() ó,é=é,ó end)
   function btnr(b)
...
--save system
 ...
 --dialog:queue("created by niall chandler, with music by chris donnelly (gruber), and translated by (your name).")
  ...
  dialog:queue("jerry_boy, miziziziz of https://bit.ly/2hl29q6, gruber_music, nerdy teachers of https://rb.gy/a5wyvv, freds72, pizza_boys, johanp, bonevolt, fast121, vahe2003, ultrachris64, rustybailey, pegboardnerds, thijsengel, sophie houlden, zep, davbo, and my friends & family á")
  dialog:queue("if it weren't for all of them, this game would never have been made.")
  dialog:queue("you can press é to go back to the title screen.")
...
function init_game()
 ...
 --coin count 
  print("è"..player.coins.."/12",camera(cam_x+0),2,1)
  print("è"..player.coins.."/12",camera(cam_x+0),1,10)
  
 --speedrun timer
  if sprun==1 then
   print("ì"..hours.."h "..minutes.."m "..seconds.."s "..milliseconds.."f",camera(cam_x+0),9,1)
   print("ì"..hours.."h "..minutes.."m "..seconds.."s "..milliseconds.."f",camera(cam_x+0),8,8)
  end
...
function draw_menu()
 ...
 --title screen text
  ...
  --standard text
  print("pRESS ó/é TO PLAY",26,56,1)
  print("pRESS ó/é TO PLAY",26,55,10)
...
function draw_win()
  ...
  print("ííííííyou winíííííí",2,1,10)
  --print("íííícongradulationsíííí",2,1,10)
  print("ÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅ",0,8,7)
...
function draw_death()
  ...
  music(-1)
  spr(player.sp,player.x,player.y,1,1,player.flp) 
  print("yOU DIED. pRESS ó/é TO RETRY.",camera(cam_x+0),1,1)
  print("yOU DIED. pRESS ó/é TO RETRY.",camera(cam_x+0),0,7)
end
...
print("ÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅ",1,60,7)
--controls
print("controls",48,67,6)
print("ã     move left",20,75,6)
print("ë     move right",20,81,6)
print("î     look up",20,87,6)
print("É     crouch",20,93,6)
print("ó     jump",20,100,6)
print("f6     save screenshot",20,107,6)
print("f9     save gif to desktop",20,113,6)
--continue
print("pRESS ó/é TO CONTINUE",18,123,1)
print("pRESS ó/é TO CONTINUE",18,122,10)
end
