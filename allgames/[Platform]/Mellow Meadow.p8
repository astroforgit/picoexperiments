...
--toggle jump btn in pause menu
  ...
  menuitem(2,"swap buttons éó",function() ó,é=é,ó end)
function btnr(b)
...
function _init()
  ...
  dialog:queue("miziziziz of https://bit.ly/2hl29q6, nerdy teachers of https://rb.gy/a5wyvv, freds72, pizza_boys, bonevolt, fast121, vahe2003, ultrachris64, rustybailey, pegboardnerds, thijsengel, sophie houlden, zep, and my friends & family á")
...
function init_game()
 ...
 --speedrun timer
  if level==1 then
	 print("ì:"..b/60,camera(cam_x+0),2,0)
	 print("ì:"..b/60,camera(cam_x+0),1,8)
	 elseif level==2 then
  print("ì:"..b/60,camera(cam_x+0),2,0)
	 print("ì:"..b/60,camera(cam_x+0),1,8)
	 elseif level==3 then
 ...
 --coin count 
  if level==1 then		
  print("è:"..player.coins.."/12",camera(cam_x+0),9,0)
  print("è:"..player.coins.."/12",camera(cam_x+0),8,10)
  elseif level==2 then
  print("è:"..player.coins.."/12",camera(cam_x+0),9,0)
  print("è:"..player.coins.."/12",camera(cam_x+0),8,10)
  elseif level==3 then
...
function update_menu()
 ...
 if(btn(ã)) angle-=1/256
 if(btn(ë)) angle+=1/256
...
function draw_menu()
 ...
 --text
  ...
  --standard text
  print("pRESS é/ó TO PLAY",26,56,1)
  print("pRESS é/ó TO PLAY",26,55,7)
...
function draw_win()
  ...
  print("ííííííyou winíííííí",2,0,10)
...
function draw_death()
  ...
  music(-1)
  spr(player.sp,player.x,player.y,1,1,player.flp) 
  print("yOU DIED. pRESS é/ó TO RETRY",camera(cam_x+0),1,1)
  print("yOU DIED. pRESS é/ó TO RETRY",camera(cam_x+0),0,7)
end
...
function draw_death2()
  ...
  music(-1)
  spr(player.sp,player.x,player.y,1,1,player.flp) 
  print("tIME UP. pRESS é/ó TO RETRY",camera(cam_x+0),1,1)
  print("tIME UP. pRESS é/ó TO RETRY",camera(cam_x+0),0,7)
end
